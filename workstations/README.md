...
A workstation is **a place you work**, not a checklist Claude runs alone. Use one when the task needs human judgment and back-and-forth — Claude assists, you make the calls. The test from Jeff Su's video: *is this a place I work, or a thing I do?* Places you work → workstation. Things Claude does the same way every time → `/skills`.
...
- `linkedin-content/` — planning and drafting LinkedIn/dev posts about this Cowork build
